...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.arsipBpj.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.arsip-bpjs.update", [$arsipBpj->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nama_ptk') ? 'is-invalid' : '' }}" name="nama_ptk_id" id="nama_ptk_id" required>
                    @foreach($nama_ptks as $id => $entry)
                        <option value="{{ $id }}" {{ (old('nama_ptk_id') ? old('nama_ptk_id') : $arsipBpj->nama_ptk->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_bpjs_pegawai') ? 'is-invalid' : '' }}" type="text" name="no_bpjs_pegawai" id="no_bpjs_pegawai" value="{{ old('no_bpjs_pegawai', $arsipBpj->no_bpjs_pegawai) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_bpjs_suami_istri') ? 'is-invalid' : '' }}" type="text" name="no_bpjs_suami_istri" id="no_bpjs_suami_istri" value="{{ old('no_bpjs_suami_istri', $arsipBpj->no_bpjs_suami_istri) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_bpjs_anak_1') ? 'is-invalid' : '' }}" type="text" name="no_bpjs_anak_1" id="no_bpjs_anak_1" value="{{ old('no_bpjs_anak_1', $arsipBpj->no_bpjs_anak_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_bpjs_anak_2') ? 'is-invalid' : '' }}" type="text" name="no_bpjs_anak_2" id="no_bpjs_anak_2" value="{{ old('no_bpjs_anak_2', $arsipBpj->no_bpjs_anak_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_bpjs_anak_3') ? 'is-invalid' : '' }}" type="text" name="no_bpjs_anak_3" id="no_bpjs_anak_3" value="{{ old('no_bpjs_anak_3', $arsipBpj->no_bpjs_anak_3) }}">
