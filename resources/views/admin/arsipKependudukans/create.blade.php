...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.arsipKependudukan.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.arsip-kependudukans.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_nik') ? 'is-invalid' : '' }}" type="text" name="no_nik" id="no_nik" value="{{ old('no_nik', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_kk') ? 'is-invalid' : '' }}" type="text" name="no_kk" id="no_kk" value="{{ old('no_kk', '') }}">
                @if($errors->has('no_kk'))
