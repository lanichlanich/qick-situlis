...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.suratMasuk.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.surat-masuks.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pengirim') ? 'is-invalid' : '' }}" type="text" name="pengirim" id="pengirim" value="{{ old('pengirim', '') }}" required>
