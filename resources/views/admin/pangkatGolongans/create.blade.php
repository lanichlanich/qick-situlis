...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.pangkatGolongan.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.pangkat-golongans.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('golongan') ? 'is-invalid' : '' }}" type="text" name="golongan" id="golongan" value="{{ old('golongan', '') }}" required>
